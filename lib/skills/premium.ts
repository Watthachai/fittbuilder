...
export const CROSS_DOMAIN_PREMIUM: PremiumOption[] = [
  ...
  },
  {
    ...
    effortDays: 4,
    build:
      "ช่องถามเป็นภาษาไทยที่ตอบจากข้อมูลในระบบเท่านั้น ห้ามแต่งตัวเลข พร้อมชี้ว่าคำตอบมาจากรายการไหน",
  },
];
...
export function buildPremiumContext(options: PremiumOption[]): string {
  ...
  return [
    "## เวอร์ชัน Premium ของระบบนี้",
    "สร้างสิ่งเหล่านี้ให้ทำงานได้จริงบนข้อมูลที่มีอยู่ในระบบ (ห้ามเป็นปุ่มหลอกหรือหน้าจอเปล่า):",
    ...lines,
    "",
