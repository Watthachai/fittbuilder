...
export const metadata = {
  ...
  description:
    "รับงานพัฒนาเว็บในนามบริษัทคุณ ใช้ FITT Builder สร้างระบบ และออกใบเสนอราคาด้วยโลโก้ของคุณเอง",
};
...
const STEPS = [
  ...
  {
    title: "รับงานได้เลย",
    body: "สร้างระบบให้ลูกค้าคุณ ออกใบเสนอราคาในนามบริษัทคุณ เราอยู่ข้างหลังในฐานะเครื่องมือ ไม่ใช่คู่แข่ง",
  },
];
