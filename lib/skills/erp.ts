...
- Spend เดือนนี้: ฿1.02M`,
  ...
  premiumOptions: [
    ...
    { id: "promise", name: "ตอบได้ทันทีว่ารับออเดอร์นี้แล้วส่งทันไหม", pitch: "ฝ่ายขายรับปากวันส่งโดยไม่รู้กำลังผลิตจริง แล้วกลายเป็นส่งช้า — ให้ตอบลูกค้าได้ตั้งแต่ตอนคุย", requires: ["production"], effortDays: 5, build: "จำลองคิวงานปัจจุบัน + วัตถุดิบคงเหลือ → วันส่งที่เป็นไปได้ และบอกว่าอะไรคือข้อจำกัด" },
    { id: "deadstock", name: "จับของค้างสต็อกและของใกล้หมดอายุ", pitch: "เงินจมอยู่ในของที่ไม่ขยับ และของหมดอายุคือขาดทุนเงียบๆ", requires: ["stock"], effortDays: 2, build: "จัดอันดับตามวันไม่เคลื่อนไหวและวันหมดอายุ พร้อมมูลค่าเงินจมรวม และปุ่มเสนอโปรระบาย" },
    { id: "pickpath", name: "เส้นทางหยิบของในคลัง", pitch: "คนหยิบของเดินซ้ำไปมาทั้งวัน — จัดลำดับตามผังคลังให้เดินรอบเดียวจบ", requires: ["warehouse"], effortDays: 3, build: "ผังคลังแบบ grid + จัดลำดับรายการหยิบตามตำแหน่ง แสดงเส้นทางและระยะที่ประหยัดได้" },
  ],
};
