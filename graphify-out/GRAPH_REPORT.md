...
## Corpus Check
- 339 files · ~495,807 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1489 nodes · 2749 edges · 158 communities (151 shown, 7 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 396 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f3991aba`
...
- `launchInterview()` --calls--> `createProject()`  [INFERRED]
  components/landing/LaunchPad.tsx → lib/storage.ts
- `handleDuplicate()` --calls--> `duplicateProject()`  [INFERRED]
  components/projects/ProjectsDrawer.tsx → lib/storage.ts
...
## Communities (158 total, 7 thin omitted)
...
Cohesion: 0.09
Nodes (25): docOnlyFiles(), docsFromFiles(), hasRunnableApp(), undocumentedScreens(), buildFittcorePayload(), buildFittcoreSpec(), downloadFittcoreSpec(), fittcoreBodyPreview() (+17 more)

### Community 5 - "Community 5"
Cohesion: 0.1
Nodes (19): POST(), DELETE(), PATCH(), getAdminUser(), checkGenerationQuota(), currentPrice(), estimateCostUsd(), startOfMonthIso() (+11 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (18): designStyleDirective(), fetchDesignOptions(), captureDnaFromText(), streamAgent(), streamGenerate(), streamInterview(), appendMessage(), clearDraft() (+10 more)
...
Cohesion: 0.14
Nodes (14): POST(), POST(), oversizedFiles(), isBuildPhase(), buildAgentSystemPrompt(), buildGenerationSystemPrompt(), buildIterationSystemPrompt(), buildIterationUserPrompt() (+6 more)
...
Cohesion: 0.18
Nodes (19): projectToRow(), rowToProject(), trimOldDiffs(), isPhaseId(), approvePhase(), createProject(), deleteProject(), duplicateProject() (+11 more)
...
Cohesion: 0.18
Nodes (8): accept(), currentUser(), currentUserId(), watch(), acceptMyInvite(), listMyInvites(), saveQuote(), createClient()
...
Cohesion: 0.15
Nodes (8): updateOrgBrand(), uploadOrgLogo(), useSkills(), onChange(), pull(), push(), upload(), pick()
...
Cohesion: 0.21
Nodes (9): removeReport(), run(), createWorkspace(), removeReport(), run(), normalizeHealthResult(), deleteAdvisorReport(), listAdvisorReports() (+1 more)

### Community 35 - "Community 35"
Cohesion: 0.19
Nodes (10): onPickFiles(), onPickFiles(), cellText(), csvEscape(), fileToAttachment(), textToBase64(), xlsxToCsvAttachment(), clearResult() (+2 more)

### Community 36 - "Community 36"
Cohesion: 0.15
Nodes (9): appendDnaBlock(), archetypeMeta(), clearOrgPainRadar(), deleteOrg(), dnaCompleteness(), updateOrgDna(), updateOrgMeta(), OrgDnaEditor() (+1 more)
...
Cohesion: 0.22
Nodes (8): createWorkspace(), openCreateWorkspace(), resolveIcon(), WorkspaceIcon(), handleCreate(), onCreate(), create(), select()
...
Cohesion: 0.18
Nodes (4): remove(), confirm(), handleDelete(), handleDuplicate()
...
Cohesion: 0.29
Nodes (7): POST(), parseHealthResult(), getProjectOrgDnaContext(), buildOrgDnaContext(), POST(), buildPremiumAdviceUser(), parsePremiumAdvice()
...
Cohesion: 0.27
Nodes (9): compress(), decodeShareFragment(), decompress(), encodeShareUrl(), fromBase64Url(), toBase64Url(), handleShare(), handlePopOut() (+1 more)
...
Cohesion: 0.29
Nodes (9): openOrgDna(), coercePainRadar(), createOrg(), ensureDefaultOrg(), firstOrg(), getOrg(), listOrgs(), rowToOrg() (+1 more)
...
Cohesion: 0.29
Nodes (3): sse(), recordUsage(), parseGeneratedSkill()

### Community 66 - "Community 66"
Cohesion: 0.39
Nodes (4): buildSpecContext(), truncateBrief(), truncateDoc(), getPreset()
...
Cohesion: 0.48
Nodes (5): emit(), resolveCreateWorkspace(), subscribeCreateWorkspace(), create(), onKey()
...
- **Why does `print()` connect `Community 43` to `Community 0`, `Community 2`, `Community 7`, `Community 12`, `Community 15`, `Community 16`, `Community 17`, `Community 19`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 28`, `Community 30`, `Community 33`, `Community 41`, `Community 42`, `Community 44`, `Community 49`, `Community 56`, `Community 61`, `Community 67`, `Community 68`, `Community 74`, `Community 75`, `Community 76`, `Community 85`, `Community 90`?**
  _High betweenness centrality (0.279) - this node is a cross-community bridge._
- **Why does `str()` connect `Community 73` to `Community 0`, `Community 65`, `Community 2`, `Community 3`, `Community 10`, `Community 42`, `Community 12`, `Community 76`, `Community 15`, `Community 16`, `Community 17`, `Community 21`, `Community 56`, `Community 24`, `Community 61`, `Community 25`?**
  _High betweenness centrality (0.195) - this node is a cross-community bridge._
- **Why does `getOrg()` connect `Community 53` to `Community 0`, `Community 36`, `Community 6`, `Community 31`?**
