...
export const ECOMMERCE: SkillTemplate = {
  ...
  premiumOptions: [
    ...
    { id: "advisor", name: "ผู้ช่วยเลือกของ", pitch: "คนซื้อไม่รู้ว่ารุ่นไหนเหมาะกับตัวเอง เลยออกจากเว็บไปถามที่อื่น — ให้ถามเป็นภาษาคนแล้วระบบคัดรุ่นที่ใช่ให้พร้อมเหตุผล", requires: ["product"], effortDays: 3, build: "แผงแชทข้างสินค้า ถามกลับเรื่องขนาด/งบ/การใช้งาน แล้วกรองรายการจริงในเดโมพร้อมบอกเหตุผลที่เลือก" },
