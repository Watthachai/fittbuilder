...
- การตัดสินใจรออนุมัติ: 1`,
  ...
  premiumOptions: [
    { id: "scenario", name: "จำลองว่า “ถ้า…แล้วจะเป็นยังไง”", pitch: "การตัดสินใจใหญ่ถูกเถียงกันด้วยความเห็น เพราะไม่มีใครลองตัวเลขให้ดูได้ในที่ประชุม", requires: [], effortDays: 5, build: "ตัวเลื่อนปรับสมมติฐานหลัก (ราคา ต้นทุน กำลังคน) แล้วผลกระทบวิ่งทันทีทั้งหน้า พร้อมบันทึกสถานการณ์ไว้เทียบกัน" },
    { id: "boardpack", name: "สร้างชุดเอกสารประชุมบอร์ด", pitch: "หนึ่งสัปดาห์ก่อนประชุมหมดไปกับการรวมสไลด์จากทุกฝ่าย", requires: [], effortDays: 3, build: "ประกอบสรุปผู้บริหาร ตัวเลขสำคัญ และประเด็นที่ต้องตัดสินใจ เป็นเอกสารพิมพ์ได้ในรูปแบบเดียวกันทุกเดือน" },
    { id: "drilldown", name: "ไล่จากตัวเลขรวมลงถึงรายการต้นทาง", pitch: "พอถามว่า “ทำไมตัวเลขนี้ตก” แล้วต้องรอฝ่ายบัญชีสามวัน", requires: [], effortDays: 4, build: "คลิกตัวเลขรวมแล้วแตกลงทีละชั้นจนถึงรายการจริง พร้อมบอกว่าชั้นไหนคือตัวที่ทำให้เปลี่ยน" },
  ],
};
