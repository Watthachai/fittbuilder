...
//
// /marketplace and /erp are the same visit: browse the modules, open the running
// system on one, decide. Both are reached before anyone has an account. Gating it
