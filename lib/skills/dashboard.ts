...
export const DASHBOARD: SkillTemplate = {
  ...
  premiumOptions: [
    ...
    { id: "askdata", name: "ถามเป็นภาษาคน ตอบจากข้อมูลจริง", pitch: "คำถามที่ผู้บริหารอยากรู้ ไม่เคยตรงกับกราฟที่มีอยู่พอดี", requires: [], effortDays: 4, build: "ช่องถามที่ตอบจากข้อมูลในระบบเท่านั้น พร้อมกราฟประกอบคำตอบและบอกว่าอ้างอิงจากตัวเลขชุดไหน" },
