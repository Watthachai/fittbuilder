export const CO_DATA = `import { material, FINISHED_GOODS } from "../mm/data";
...
export function productCost(code) {
...
export const CO_SCREEN = `import { useState } from "react";
import {
