...
export const CHANGELOG: ChangelogEntry[] = [
  {
    version: "0.58.4",
    date: "2026-08-26",
    title: "🪪 ที่อยู่หัวกระดาษไหลลงบรรทัดเองอย่างเป็นระเบียบ",
    items: [
      {
        type: "fix",
        text: "ที่อยู่บนใบเสนอราคา/ข้อเสนอเคยขึ้นบรรทัดตามที่พิมพ์เป๊ะ ถ้าเผลอเคาะบรรทัดผิดที่ (เช่นหลัง \"แขวงหัวหมาก\") คำจะหลุดไปค้างเดี่ยวๆ — ตอนนี้ระบบไหลข้อความให้เต็มบรรทัดเองและตัดที่ขอบคำ ไม่ต้องกังวลว่ากรอกในช่องมากี่บรรทัด (ยืนยันด้วยการจำลองหน้ากระดาษ A4 จริงในเบราว์เซอร์)",
      },
    ],
  },
  {
