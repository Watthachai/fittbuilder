...
export const CHANGELOG: ChangelogEntry[] = [
  {
    version: "0.43.0",
    date: "2026-07-24",
    title: "FITT Advisor แยกเป็นโมดูลของตัวเอง + ตรวจสุขภาพธุรกิจ 5 ด้าน",
    items: [
      { type: "feature", text: "หน้าใหม่ /advisor — ศูนย์รวมการวิเคราะห์ขององค์กร: วางข้อมูลจริง (ข้อความ/ไฟล์ รวม Excel) แล้วเลือกเลนส์ “หา Pain Point” หรือ “ตรวจสุขภาพธุรกิจ” · ช่วง alpha เมนูโชว์เฉพาะ admin (top nav แทนที่เมนูราคา + เมนูบัญชี พร้อมป้าย ALPHA)" },
