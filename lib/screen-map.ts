...
export const SCREEN_MAP_SYSTEM = `คุณกำลังอ่านซอร์สโค้ดของเว็บระบบ (Vite + React) แล้วสรุป "แผนผังหน้าจอ" เพื่อเอาไปเดินแคปหน้าจอทีละหน้าโดยอัตโนมัติ
...
ค่าทุกช่องต้องมาจากโค้ดของระบบที่กำลังอ่านอยู่เท่านั้น ห้ามลอกตัวอย่างข้างบน
...
export function buildScreenMapUser(files: ProjectFiles): string {
  ...
  return `ไฟล์ที่เกี่ยวกับการนำทางของระบบนี้:\n\n${dump}`;
}
