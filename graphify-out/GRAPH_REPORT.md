# Graph Report - fitt-builder-v2  (2026-07-15)

## Corpus Check
- 239 files · ~339,932 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1162 nodes · 1931 edges · 105 communities (102 shown, 3 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 193 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f637c6d9`
...
- `POST()` --calls--> `createAdminClient()`  [INFERRED]
  app/api/org-advisor/route.ts → lib/supabase/admin.ts
- `POST()` --calls--> `parseAdvisorResult()`  [INFERRED]
  app/api/org-advisor/route.ts → lib/org-advisor.ts

## Communities (105 total, 3 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (51): POST(), POST(), POST(), stripFences(), POST(), stripFence(), POST(), POST() (+43 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (35): POST(), DELETE(), PATCH(), isAdminEmail(), getAdminUser(), estimateCostUsd(), deleteOrgSkill(), getOrgSkill() (+27 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (38): openOrgDna(), fileToAttachment(), normalizeAdvisorResult(), parseAdvisorResult(), appendDnaBlock(), archetypeMeta(), clearOrgPainRadar(), coercePainRadar() (+30 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (31): accept(), applyTheme(), choose(), isChangelogUnseen(), latestVersion(), acceptMyInvite(), listMyInvites(), createOrgInvite() (+23 more)
...
Cohesion: 0.11
Nodes (17): deleteMessage(), groupReactions(), loadMessages(), rowToMessage(), sendMessage(), sendSystemMessage(), toggleReaction(), uploadAttachment() (+9 more)
...
Cohesion: 0.1
Nodes (13): docOnlyFiles(), hasRunnableApp(), designStyleDirective(), fetchDesignOptions(), captureDnaFromText(), baseDeps(), extraDepsOf(), packageJsonWithDeps() (+5 more)
...
Cohesion: 0.2
Nodes (18): createInvite(), disableShareLink(), getShareToken(), listInvites(), removeMember(), renewShareLink(), revokeInvite(), setShareLink() (+10 more)
...
- **Why does `createClient()` connect `Community 3` to `Community 1`, `Community 2`, `Community 6`, `Community 7`, `Community 9`, `Community 12`, `Community 19`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `confirm()` connect `Community 26` to `Community 1`, `Community 2`, `Community 34`, `Community 3`, `Community 38`, `Community 9`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `isBuildPhase()` connect `Community 0` to `Community 9`, `Community 30`, `Community 7`?**
