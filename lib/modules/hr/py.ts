...
export const PY: Module = {
  ...
  maPerMonth: 5000,
  build:
    "หน้าเงินเดือน เปิดมาเจอภาพรวมที่บอกยอดจ่ายทั้งงวด โครงสร้างรายได้ ต้นทุนแรงงานย้อนหลัง สถานะงวด และรายการที่ต้องดูก่อนอนุมัติ เลือกงวดได้ทุกหน้า จากนั้นเข้าดูได้ห้าส่วน · คำนวณเงินเดือน (ตารางรายได้/หัก/สุทธิรายคน เปิดสลิปเต็มใบที่แจกแจงทุกบรรทัด) · สวัสดิการ (ผังสวัสดิการที่ประกาศใช้ แยกรายการที่นำไปคำนวณภาษีกับที่ยกเว้น และยอดรายคน) · ขาดลามาสาย (วันขาด ลาไม่รับค่าจ้าง นาทีสาย แปลงเป็นยอดหักตามฐานเงินเดือนต่อวัน/ต่อชั่วโมง) · ภาษีและประกันสังคม (ประกันสังคม 5% เพดาน 750 บาท สมทบนายจ้าง กองทุนสำรองเลี้ยงชีพ และภาษีหัก ณ ที่จ่ายจากขั้นภาษีจริงพร้อมตารางขั้น) · การจ่ายเงิน (รายการโอนเข้าบัญชีรายคน แยกตามวิธีจ่าย พร้อมยอดรวมทั้งงวดและสถานะงวด) · ทุกหน้ามีปุ่มทำงานจริง: เปิดงวดใหม่ คำนวณเงินเดือน (พนักงานใหม่เข้างวดทันทีด้วยเงินเดือนตามสัญญาคิดตามสัดส่วนวัน) อนุมัติและล็อกงวด ปลดล็อกพร้อมเหตุผล บันทึกการจ่าย เพิ่ม/แก้/ลบโบนัส คอมมิชชั่น เบิกล่วงหน้า กยศ. (ภาษีเงินได้ครั้งคราวคิดส่วนเพิ่มทั้งปี หักรวมไม่เกินหนึ่งในห้าตามมาตรา 76) แก้ขาดลามาสายพร้อมเหตุผล บันทึกและอนุมัติใบเบิกสวัสดิการตามวงเงินต่อปี ปรับสวัสดิการประจำ พิมพ์สลิปรายคนและทั้งงวด พิมพ์และส่งออก ภ.ง.ด.1 สปส.1-10 หนังสือรับรอง 50 ทวิ ใบนำส่งธนาคาร และสร้างไฟล์โอนเงิน",
  files: filesFor("py", ["screen.tsx", "data.ts", "shared.tsx", "forms.tsx", "records.tsx", "documents.tsx"]),
};
