...
## Corpus Check
- 336 files · ~485,881 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1483 nodes · 2746 edges · 152 communities (144 shown, 8 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 396 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `42b797b7`
...
- `POST()` --calls--> `rateLimit()`  [INFERRED]
  app/api/detect-skill/route.ts → lib/rate-limit.ts
...
Cohesion: 0.08
Nodes (20): docOnlyFiles(), hasRunnableApp(), designStyleDirective(), fetchDesignOptions(), captureDnaFromText(), streamAgent(), streamGenerate(), streamInterview() (+12 more)
...
Cohesion: 0.13
Nodes (13): str(), main(), Attempt zone transfer (AXFR) on nameservers., Resolve a single subdomain to IP address(es)., Test a single subdomain candidate., Brute-force subdomain enumeration using a wordlist., Detect wildcard DNS resolution., Resolve all discovered subdomains to IPs. (+5 more)
...
Cohesion: 0.13
Nodes (8): accept(), currentUser(), currentUserId(), watch(), acceptMyInvite(), listMyInvites(), useTheme(), createClient()
...
Cohesion: 0.16
Nodes (14): capContent(), computeChanges(), deriveProductName(), GenerationParseError, isSafePath(), mergeFiles(), normalizePath(), parseGeneration() (+6 more)

### Community 22 - "Community 22"
Cohesion: 0.26
Nodes (13): POST(), stripFence(), POST(), POST(), POST(), currentUserId(), generateText(), detectPresetByKeywords() (+5 more)
...
Cohesion: 0.18
Nodes (12): createWorkspace(), openOrgDna(), createWorkspace(), firstOrg(), listOrgs(), openCreateWorkspace(), resolveIcon(), WorkspaceIcon() (+4 more)
...
Cohesion: 0.18
Nodes (9): POST(), POST(), parseHealthResult(), getProjectOrgDnaContext(), buildOrgDnaContext(), isBuildPhase(), POST(), buildPremiumAdviceUser() (+1 more)
...
Cohesion: 0.18
Nodes (9): POST(), POST(), preCheck(), POST(), buildInterviewSystemPrompt(), getLimiter(), getRedis(), rateLimit() (+1 more)

### Community 35 - "Community 35"
Cohesion: 0.16
Nodes (6): POST(), stripFences(), sse(), recordUsage(), MissingApiKeyError, parseGeneratedSkill()
...
Cohesion: 0.22
Nodes (9): removeReport(), run(), removeReport(), run(), normalizeHealthResult(), deleteAdvisorReport(), listAdvisorReports(), reportScore() (+1 more)
...
Cohesion: 0.24
Nodes (4): applyTheme(), choose(), useDismiss(), Overlay()
...
Cohesion: 0.36
Nodes (7): createOrg(), ensureDefaultOrg(), emit(), resolveCreateWorkspace(), subscribeCreateWorkspace(), create(), onKey()
...
Cohesion: 0.4
Nodes (3): isDraftLive(), loadDraft(), tick()
...
- **Why does `print()` connect `Community 41` to `Community 0`, `Community 1`, `Community 6`, `Community 10`, `Community 12`, `Community 13`, `Community 15`, `Community 18`, `Community 19`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 33`, `Community 36`, `Community 39`, `Community 40`, `Community 42`, `Community 47`, `Community 52`, `Community 62`, `Community 63`, `Community 69`, `Community 70`, `Community 71`, `Community 81`, `Community 86`?**
  _High betweenness centrality (0.265) - this node is a cross-community bridge._
- **Why does `str()` connect `Community 12` to `Community 0`, `Community 1`, `Community 35`, `Community 71`, `Community 9`, `Community 10`, `Community 42`, `Community 13`, `Community 15`, `Community 52`, `Community 20`, `Community 22`, `Community 25`, `Community 26`, `Community 60`?**
  _High betweenness centrality (0.194) - this node is a cross-community bridge._
- **Why does `parseDoc()` connect `Community 0` to `Community 1`, `Community 60`, `Community 12`?**
